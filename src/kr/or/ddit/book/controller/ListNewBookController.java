...
@WebServlet("/book/newList.do")
public class ListNewBookController extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//전체 글 갯수 , 총 데이터 개수
		int totalCount = bookService.newCountList();
...
//				
//				//범위 별 게시물 가져오기
		List<BookVO> list = bookService.newBoardList(map);
		...
		req.setAttribute("active", "newList");
		req.getRequestDispatcher("/views/book/newList.jsp").forward(req, resp);
	}
