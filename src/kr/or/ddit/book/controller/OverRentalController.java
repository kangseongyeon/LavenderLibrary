...
@WebServlet("/rental/overRental.do")
public class OverRentalController extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		IBookService bookService=BookService.getInstance();
		
		List<RentalVO> rentalList=bookService.getOverRental();
		...
		//전체 글 갯수 , 총 데이터 개수
		int totalCount = bookService.overRentalCountList();
...
//								
//				//범위 별 게시물 가져오기
		List<RentalVO> list = bookService.overRentalBoardList(map);
		...
		req.getRequestDispatcher("/views/rental/overList.jsp").forward(req, resp);
	}
