...
public class ListRentalController extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		IBookService bookService= BookService.getInstance();
		
		List<RentalVO> rentalList=bookService.getAllRental();
		...
		//전체 글 갯수 , 총 데이터 개수
		int totalCount = bookService.rentalCountList();
...
//				
//				//범위 별 게시물 가져오기
		List<RentalVO> list = bookService.rentalBoardList(map);
		...
		req.getRequestDispatcher("/views/rental/list.jsp").forward(req, resp);
