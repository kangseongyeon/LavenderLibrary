...
public class ListNewsController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<NewsVO> newsList = newsService.getTotalNews();
		...
		//전체 글 갯수 , 총 데이터 개수
		int totalCount = newsService.countList();
...
//		
//		//범위 별 게시물 가져오기
		List<NewsVO> list = newsService.boardList(map);
		...
		req.setAttribute("active", "newsList");
		req.getRequestDispatcher("/views/news/newsList.jsp").forward(req, resp);
	}
