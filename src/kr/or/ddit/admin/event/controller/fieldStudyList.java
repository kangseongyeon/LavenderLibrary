...
@WebServlet("/adminEvent/fieldStudyList.do")
public class fieldStudyList extends HttpServlet{
   ...
   protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      ...
      //전체 글 갯수 , 총 데이터 개수
      int totalCount = eventService.fieldstudyCountList();
...
//      
//      //범위 별 게시물 가져오기
      List<EventVO> list = eventService.fieldstudyBoardList(map);
      ...
      req.setAttribute("active", "fieldStudyList");
      req.getRequestDispatcher("/views/adminEvent/fieldstudy.jsp").forward(req, resp);
