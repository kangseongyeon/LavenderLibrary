...
@WebServlet("/adminEvent/movieList.do")
public class movieList extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//전체 글 갯수 , 총 데이터 개수
		int totalCount = eventService.movieCountList();
...
//		
//		//범위 별 게시물 가져오기
		List<EventVO> list = eventService.movieBoardList(map);
		...
		req.setAttribute("active", "moiveList");
		req.getRequestDispatcher("/views/adminEvent/moiveList.jsp").forward(req, resp);
