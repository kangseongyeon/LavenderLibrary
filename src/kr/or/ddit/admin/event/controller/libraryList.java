...
@WebServlet("/adminEvent/libraryList.do")
public class libraryList extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//전체 글 갯수 , 총 데이터 개수
		int totalCount = eventService.eventCountList();
...
//		
//		//범위 별 게시물 가져오기
		List<EventVO> list = eventService.eventBoardList(map);
		...
		req.setAttribute("active", "libraryList");
		req.getRequestDispatcher("/views/adminEvent/libraryList.jsp").forward(req, resp);
