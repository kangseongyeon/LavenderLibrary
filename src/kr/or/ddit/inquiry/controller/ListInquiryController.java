...
public class ListInquiryController extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<InquiryVO> inquiryList = inquiryService.getInquiryList();
		...
		//전체 글 갯수 , 총 데이터 개수
		int totalCount = inquiryService.countList();
		...
		//      		
		//      		//범위 별 게시물 가져오기
		List<InquiryVO> list = inquiryService.boardList(map);
		...
		req.setAttribute("active", "inquiryList");
        req.getRequestDispatcher("/views/inquiry/inquiryList.jsp").forward(req, resp);
    }
