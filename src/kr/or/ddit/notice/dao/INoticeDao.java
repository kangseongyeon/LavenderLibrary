...
public interface INoticeDao {
	/**
	 * NoticeVO에 담겨진 공지 정보를 DB에 Insert하기 위한 메서드
	 * 
	 * @param nv 공지정보를 담은 MenverVO 객체
	...
	/**
	 * NoticeVO에 담겨진 공지정보를 DB에 update하기 위한 메서드
	 * 
	 ...
	 * 
	 * @param noticeNo 존재여부 확인하기위한 공지No
	 ...
	 * 
	 * @param noticeNo 상세정보를 조회할 공지 No
	 ...
	 * 해당 공지정보를 삭제하기위한 메서드
	 * 
	 * @param noticeNo noticeNo 삭제하고자 하는 공지No
	 * @return 삭제처리가 성공하면 1, 실패하면 0 반환
	 */
	public int deleteNotice(String noticeNo);

	/**
	 * DB에 존재하는 모든 공지정보를 가져오기위한 메서드
	 * 
	...
	/**
	 *  공지정보를 검색하기 위한 메서드
	 * @param nv 검색할 공지정보를 담은 MrmberVO객체
