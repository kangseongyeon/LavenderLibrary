...
@WebServlet("/main/listBlack.do")
public class ListBlaklistController extends HttpServlet {

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		
		IMemberService memberService = MemberServiceImpl.getInstance();
		List<MemberVO> memberList = memberService.getBlacklist();
		...
		req.setAttribute("memberList", memberList);
	      ...
	      //전체 글 갯수 , 총 데이터 개수
	      int totalCount = memberService.blacklistCountList();
...
//	      
//	      //범위 별 게시물 가져오기
	      List<MemberVO> list = memberService.blacklistBoardList(map);
		...
		req.getRequestDispatcher("/views/admin/listBlack.jsp").forward(req, resp);
	}
