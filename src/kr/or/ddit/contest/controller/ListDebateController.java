...
@WebServlet("/debate/list.do")
public class ListDebateController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<DebateVO> debateList = debateService.getAllDebates();
		...
		//전체 글 갯수 , 총 데이터 개수
		int totalCount = debateService.countList();
...
//		
//		//범위 별 게시물 가져오기
		List<DebateVO> list = debateService.boardList(map);
		...
		req.setAttribute("active", "listD");
		req.getRequestDispatcher("/views/debate/listD.jsp").forward(req, resp);
	}
