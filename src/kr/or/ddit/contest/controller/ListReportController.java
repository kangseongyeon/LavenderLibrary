...
public class ListReportController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<BookReportVO> reportList = reportService.getAllReports();
		...
		//전체 글 갯수 , 총 데이터 개수
		int totalCount = reportService.countList();
...
//		
//		//범위 별 게시물 가져오기
		List<BookReportVO> list = reportService.boardList(map);
		...
		req.setAttribute("active", "listR");
		req.getRequestDispatcher("/views/report/listR.jsp").forward(req, resp);
	}
