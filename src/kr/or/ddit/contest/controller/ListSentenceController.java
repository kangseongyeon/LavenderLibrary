...
@WebServlet("/sentence/list.do")
public class ListSentenceController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<OneSentenceVO> sentenceList = sentenceService.getAllSentences();
		...
		//전체 글 갯수 , 총 데이터 개수
		int totalCount = sentenceService.countList();
...
//		
//		//범위 별 게시물 가져오기
		List<OneSentenceVO> list = sentenceService.boardList(map);
		...
		req.setAttribute("active", "listS");
		req.getRequestDispatcher("/views/sentence/listS.jsp").forward(req, resp);
	}
