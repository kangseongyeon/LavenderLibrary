	...
	<div class="container">
		...
		<div class = "searchButton">
			...
			<div class="content-wrapper">
				<main class="main-content">
					<table class="table table-hover">
						...
						<tbody>
							...
							if (list != null && !list.isEmpty()) {
								...
								for (EventVO ev : list) {
									//         if("fieldstudy".equals(ev.getEventType())) {
							%>
					...
					<div class = "pagingButton">
						...
						}%>><a href="<%=request.getContextPath()%>/adminEvent/fieldStudyList.do?page=<%=i%>"><%=i%></a></li>
						<%
							}
						%>
						</ul>
			...
			<c:set var="loginCode" value="${sessionScope.loginCode}" />
				<c:if test="${loginCode == 'b1a4'}">
					<%-- <tr align="right">
						<td colspan="6"><a href="<%=request.getContextPath()%>/adminEvent/insert.do">[행사등록]</a></td>
					</tr> --%>
					<div class="actions" style="margin-right: 50px;">
						<a href="<%=request.getContextPath() %>/adminEvent/insert.do">[행사 등록]</a>
					</div>
			</c:if>
