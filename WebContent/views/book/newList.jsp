...
<!-- 								<img alt="표지" src="‪/img/4b46cb3669c846ac9b4a0e998132342b.jpg" class="book-image"> -->
 ...
 %>
			...
			<div class = "pagingButton">
				...
				%>
					  <li <% if(i==currentPage) {%> class="active" <% } else {}%>><a href="<%=request.getContextPath() %>/book/newList.do?page=<%=i%>"><%=i %></a></li>
				<%		
					}
				%>
				</ul>
				...
				<c:set var="loginCode" value="${sessionScope.loginCode}" />
					<c:if test="${loginCode == 'b1a4'}">
						...
						<div class="actions" style="margin-right: 50px;">
								    <a href="<%=request.getContextPath() %>/book/insert.do"><span class="glyphicon glyphicon-book"></span>도서 등록</a>
						</div>
					</c:if>
				</div>
    ...
    <%request.setAttribute("active", "newList"); %>
